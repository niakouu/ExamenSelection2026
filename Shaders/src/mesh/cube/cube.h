...
class CubeMesh : public Mesh {
    ...
    private:
        ...
        static inline constexpr float mesh[] = {
        ...
        const char* VS_SHADER_PATH = "cube/";
        const char* FS_SHADER_PATH = "cube/";
        const char* CURRENT_VS_SHADER = "cube.vs.glsl";
        const char* CURRENT_FS_SHADER = "cube.fs.glsl";
